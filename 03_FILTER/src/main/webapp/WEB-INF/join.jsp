...
<body>
    ...
    <form action="${pageContext.request.contextPath}/join.do" method="post">
        ...
        <div class="row" style="position:relative;">
            <label>아이디  </label>
            <span style="position:absolute;right:80px;top:-11px;font-size:.5rem;"> ${userid} </span>
            <input  name="userid"   type="text"  />
            <a class="btn"  href="javascript:void(0)">중복확인</a>
        </div>
        <div class="row" style="position:relative;">
            <label>비밀번호 </label>
            <span style="position:absolute;right:5px;top:-11px;font-size:.5rem;"> ${password} </span>
        ...
        <div class="row">
            ...
            <input name="tel02" type="text" />
            <input name="tel03" type="text" />
        </div>
        <div class="row">
            <label>이메일</label>
        ...
        <div class="row">
            <label>생년월일</label>
            <input name="birthType" value="a" type="radio" /> 양
            <input name="birthType" value="b" type="radio" /> 음
        </div>
        ...
        <div class="row">
            <input id="sms-recv" name="sms_recv" type="checkbox" /> 
